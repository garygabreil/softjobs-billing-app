      ...
      <div class="row mb-4">
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center">
            <h2><i class="bi bi-file-text me-2"></i>Quotation System</h2>
            <div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div
                    *ngIf="
                      customerEmailInput.invalid && customerEmailInput.touched
                    "
                    class="text-danger small mt-1"
                  >
                    <span *ngIf="customerEmailInput.errors?.['required']"
                      >Email is required</span
                    >
                    <span *ngIf="customerEmailInput.errors?.['email']"
          ...
          <div class="card shadow">
            <div class="card-header bg-primary text-white">
              <h5 class="mb-0">
                <i class="bi bi-cart-plus me-2"></i>Add Products to Quotation
              </h5>
            </div>
            <div class="card-body">
              <div class="row mb-3">
                  ...
                  >
                    ...
                    <option
                      *ngFor="let product of products()"
                      [value]="product.id"
                    >
                      {{ product.name }} - {{ product.rate | currency : 'INR' }}
                    </option>
                  </select>
                </div>
                <div class="col-md-4">
              ...
              >
                <i class="bi bi-plus-circle me-1"></i>Add to Quotation
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="card shadow h-100">
            <div class="card-header bg-primary text-white">
              <h5 class="mb-0">
                <i class="bi bi-file-text me-2"></i>Quotation Items
              </h5>
            </div>
            <div class="card-body">
              <div class="quotation-items-container">
                <div
                  *ngIf="quotationItems.length === 0"
                  class="text-center text-muted py-4"
                >
                  <p>No items added yet</p>
                </div>
                <div
                  *ngFor="let item of quotationItems; let i = index"
                  class="quotation-item-card"
                >
              ...
              <!-- Save Quotation Button with Progress -->
              <div class="mt-4">
                <button
                  *ngIf="!isSaved()"
                ...
                >
                  <span *ngIf="!isSaving()"
                    ><i class="bi bi-save me-1"></i>Save Quotation</span
                  >
                  <span *ngIf="isSaving()">
                    <span
                ...
                <!-- Print Button - Only shown after quotation is saved -->
                <button
                  *ngIf="isSaved()"
                ...
                <button
                  *ngIf="isSaved()"
                  ...
                  style="display: inline-block; width: calc(50% - 5px);"
                >
                  <i class="bi bi-file-plus me-1"></i>New Quotation
                </button>
              </div>
            </div>
          </div>
          ...
          <div class="quotation-container">
            ...
            <div class="quotation-header-section">
              ...
              <div class="header-right">
                <div class="quotation-title">QUOTATION<br />FOR APPROVAL</div>
                <table class="quotation-details">
                  <tr>
                    <td class="label">Quotation No.:</td>
                    <td class="value">{{ quotationNo }}</td>
                  </tr>
                  <tr>
...
export class QuotationComponent implements OnInit {
  ...
  get totalGst(): number {
    return this.quotationItems.reduce((sum, item) => sum + item.gstAmount, 0);
  }
  ...
  ngOnInit() {
    this.quotationNo = this.generateQuotationNo();
    this.getProducts();
  }
  ...
  calculateItem(item: QuotationItem) {
